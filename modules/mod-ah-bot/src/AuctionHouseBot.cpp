...
void AuctionHouseBot::InitializeConfiguration()
{
    ...
    AHBSeller = sConfigMgr->GetBoolDefault("AuctionHouseBot.EnableSeller", true);
    AHBBuyer = sConfigMgr->GetBoolDefault("AuctionHouseBot.EnableBuyer", true);
    SellMethod = sConfigMgr->GetBoolDefault("AuctionHouseBot.UseBuyPriceForSeller", true);
    BuyMethod = sConfigMgr->GetBoolDefault("AuctionHouseBot.UseBuyPriceForBuyer", false);

    AHBplayerAccount = sConfigMgr->GetIntDefault("AuctionHouseBot.Account", 1);
    AHBplayerGUID = sConfigMgr->GetIntDefault("AuctionHouseBot.GUID", 1);
    ItemsPerCycle = sConfigMgr->GetIntDefault("AuctionHouseBot.ItemsPerCycle", 200);

    //Begin Filters

    Vendor_Items = sConfigMgr->GetBoolDefault("AuctionHouseBot.VendorItems", true);
    Loot_Items = sConfigMgr->GetBoolDefault("AuctionHouseBot.LootItems", true);
    Other_Items = sConfigMgr->GetBoolDefault("AuctionHouseBot.OtherItems", true);
    Vendor_TGs = sConfigMgr->GetBoolDefault("AuctionHouseBot.VendorTradeGoods", true);
    Loot_TGs = sConfigMgr->GetBoolDefault("AuctionHouseBot.LootTradeGoods", true);
    Other_TGs = sConfigMgr->GetBoolDefault("AuctionHouseBot.OtherTradeGoods", true);
    ...
    DisableItemsAboveLevel = sConfigMgr->GetIntDefault("AuctionHouseBot.DisableItemsAboveLevel", 78);
